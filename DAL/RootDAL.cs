...
namespace DAL
{
	public class RootDAL
	{
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Root");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(RootModel model)
		{
			StringBuilder strSql = new StringBuilder();
			strSql.Append("insert into LateReturn(");
			strSql.Append("Adminid,Adminpwd)");
			strSql.Append(" values (");
			strSql.Append("@id,@Adminid,@Adminpwd)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(RootModel model)
		{
			StringBuilder strSql = new StringBuilder();
			strSql.Append("update Report set ");
			strSql.Append("Adminid=@Adminid,Adminpwd=@Adminpwd");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql = new StringBuilder();
			strSql.Append("delete from Root ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public RootModel GetModel(int id)
		{

			StringBuilder strSql = new StringBuilder();
			strSql.Append("select  top 1 id,Adminid,Adminpwd from AdminInfo ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public RootModel GetModel(DataRow row)
		{
			RootModel model = new RootModel();
			if (row != null)
			{
		...
		{
			StringBuilder strSql = new StringBuilder();
			strSql.Append("select  id,Adminid,Adminpwd");
			strSql.Append(" FROM Root ");
			if (strWhere.Trim() != "")
			{
